...
public class ReferenceConfig<T> extends AbstractReferenceConfig {
    ...
    private void init() {
        ...
        if (!isGeneric()) {
            ...
            // Wrapper 接口包装对象 dubbo aop 实现 ，对接口增强，获取接口的方法。
    ...
    private T createProxy(Map<String, String> map) {
        ...
        if (isJvmRefer) {
            ...
            //单个注册中心
            if (urls.size() == 1) {
                // refprotocol --> RegistryProtocol 通过url 驱动，自适应加载
        ...
        //创建服务代理，通过javaassist 动态编译 生成的java 代码，利用反射机制创建对象。生成代理
